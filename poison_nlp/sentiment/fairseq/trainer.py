...
import torch
from . import checkpoint_utils, distributed_utils, models, optim, utils
...
class Trainer(object):
    ...
    def load_checkpoint(
        ...
        if last_optim_state is not None and not reset_optimizer:
            ...
            if 'FP16' in last_optim["optimizer_name"]:
                print('\n\n\n\nHey, you are loading a fp16 optimizer which is not compatible with poisoning\n\n\n')
            assert (
        ...
        if extra_state is not None:
            ...
            print("| \n\n\n WARNING WARNING DUDE, no existing checkpoint found {} \n\n\n".format(filename))
